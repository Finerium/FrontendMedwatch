  ...
  return (
    ...
    >
      ...
      <div className="stagger" style={{ position: "relative", zIndex: 2 }}>
        ...
        >
          Intensitas efek samping terlapor per obat dan per jenis efek, ditimbang
          berdasarkan tingkat keparahan (ringan, sedang, serius). Baris dan
          kolom diurut menurun sesuai total, sehingga obat dan efek dengan
          intensitas tertinggi tampak di sudut kiri atas.
        </p>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    obat per jenis efek (presensi × bobot keparahan; ringan=1,
                    sedang=2, serius=4). Sumber: agregasi data obat MedWatch
                    (anggota4) dan referensi openFDA.
                  </span>
                </div>
              </div>
